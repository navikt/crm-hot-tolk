...
call sfdx force:package:install --package 04t2o000001MxZjAAK  -k navcrm --wait 10 --publishwait 10
call sfdx force:package:install --package 04t2o000001MxYWAA0  -k navcrm --wait 10 --publishwait 10
