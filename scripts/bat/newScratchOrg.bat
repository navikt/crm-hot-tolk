...
:: Installer crm-platform-access-control ver. 0.41
call sfdx force:package:install --package 04t2o000000yQQUAA2 -r -k navcrm --wait 10 --publishwait 10

:: Installer crm-community-base ver. 0.12
call sfdx force:package:install --package 04t2o000000yQ7cAAE -r -k navcrm --wait 10 --publishwait 10
