...
echo "Installerer crm-platform-base ver. 0.162"
call sfdx force:package:install --package 04t7U000000Tq28QAC -r -k %3 --wait 10 --publishwait 10
...
echo "Installerer crm-community-base ver. 0.69"
call sfdx force:package:install --package 04t7U000000Tq9TQAS -r -k %3 --wait 10 --publishwait 10
...
echo "Installer crm-henvendelse-base ver. 0.8"
