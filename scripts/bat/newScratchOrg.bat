...
echo "Installerer crm-platform-base ver. 0.178"
call sfdx force:package:install --package 04t7U0000008qbRQAQ -r -k %3 --wait 10 --publishwait 10

echo "Installerer crm-platform-integration ver. 0.92"
call sfdx force:package:install --package 04t7U0000008qZ6QAI -r -k %3 --wait 10 --publishwait 10
