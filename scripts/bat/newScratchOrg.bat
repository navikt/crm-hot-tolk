...
echo "Installer crm-platform-base ver. 0.277"
call sf package install --package 04tQC000000tXUnYAM --no-prompt --installation-key %3 --wait 30 --publish-wait 30
...
echo "Installer crm-platform-integration ver. 0.157"
call sf package install --package 04tQC000000ocN3YAI --no-prompt --installation-key %3 --wait 30 --publish-wait 30
