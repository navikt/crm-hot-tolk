...
call sfdx force:package:install --package 04t2o000000OA5aAAG  -k navcrm --wait 10 --publishwait 10
...
call sfdx force:package:install --package 04t2o000000OA4hAAG  -k navcrm --wait 10 --publishwait 10
