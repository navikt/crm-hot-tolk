...
echo "Installerer crm-platform-base ver. 0.140"
call sfdx force:package:install --package 04t7U000000TnNrQAK -r -k %3 --wait 10 --publishwait 10
...
echo "Installerer crm-community-base ver. 0.42"
call sfdx force:package:install --package 04t7U000000TnH0QAK -r -k %3 --wait 10 --publishwait 10
