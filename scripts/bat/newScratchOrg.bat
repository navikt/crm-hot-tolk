...
echo "Installerer crm-platform-integration ver. 0.66"
call sfdx force:package:install --package 04t2o000000yUByAAM -r -k %3 --wait 10 --publishwait 10
...
echo "Installerer crm-community-base ver. 0.39"
call sfdx force:package:install --package 04t7U000000Tn3rQAC -r -k %3 --wait 10 --publishwait 10
