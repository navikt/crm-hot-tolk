...
call sfdx force:package:install --package 04t2o000000OAH7AAO  -k navcrm --wait 10 --publishwait 10

:: Installer crm-platform-access-control
call sfdx force:package:install --package 04t2o000000OAHCAA4  -k navcrm --wait 10 --publishwait 10
